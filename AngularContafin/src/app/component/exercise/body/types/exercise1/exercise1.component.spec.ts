...
describe('Exercise1Component', () => {
  ...
  describe('ngOnInit', () => {
    it('should fetch exercise data and initialize properties', async () => {
      mockExerciseService.getExercise.and.resolveTo(mockExercise);
      mockSanitizer.bypassSecurityTrustUrl.and.callFake((url) => url);
      ...
      expect(component.img1).toBe('data:image/jpeg;base64,mockImage1');
      expect(component.img2).toBe('data:image/jpeg;base64,mockImage2');
      expect(component.img3).toBe('data:image/jpeg;base64,mockImage3');
